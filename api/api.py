...
#api.config["MYSQL_HOST"] = os.getenv("MYSQL_HOST", "3.238.249.82")
api.config["MYSQL_HOST"] = os.getenv("MYSQL_HOST")
#api.config["MYSQL_PORT"] = int(os.getenv("MYSQL_PORT", 3306))
api.config["MYSQL_PORT"] = int(os.getenv("MYSQL_PORT"))
